...
help() {
    cat << "EOF"
    ____                                               __  
   /  _/___ ___  ____ ___  ___  _________  ____  _____/ /_ 
   / // __ `__ \/ __ `__ \/ _ \/ ___/ __ \/ __ \/ ___/ __ \
 _/ // / / / / / / / / / /  __/ /  / / / / /_/ / /__/ / / /
/___/_/ /_/ /_/_/ /_/ /_/\___/_/  /_/ /_/\____/\___/_/ /_/ 
                                                        
EOF

    echo -e "${GREEN}Immernoch${RESET} version ${BROWN}$VERSION${RESET} $(date +'%Y-%m-%d %H:%m:%S')"
    ...
    echo -e "  ${GREEN}about${RESET}\t\t\t\t Shows a short information about Immernoch"
